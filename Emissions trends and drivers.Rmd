...
```{r regional_trends, echo=FALSE,warning=FALSE,fig.width=6,fig.height=4}
...
``` {r decline, echo=FALSE,warning=FALSE,fig.width=8}
...
``` {r increase, echo=FALSE,warning=FALSE,fig.width=8}
...
``` {r increase_WB, echo=FALSE,warning=FALSE,fig.width=8}
