...
```{r percapita_trends, echo=FALSE,warning=FALSE,fig.width=10,fig.height=6}
...
region <- edgar_GHG %>% 
  ...
  mutate(ghg_pc = ghg_total/pop*1000,ghg_gdp = ghg_total/gdp*1000)
...
```{r total_sector_trends,echo=FALSE,warning=FALSE,fig.width=8,fig.height=10,fig.path="Plots/",dev=c('png','pdf')}
