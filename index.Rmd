...
spm_table <- read.xlsx('Results/Plot data/ipcc_ar6_figure_spm_gases.xlsx',sheet="spm table")
...
cat("<a href='https://github.com/mcc-apsis/AR6-Emissions-trends-and-drivers/raw/master/Results/Plot%20data/ipcc_ar6_figure_regions_countries.xlsx'>data</a> | 
    <a href='https://github.com/mcc-apsis/AR6-Emissions-trends-and-drivers/blob/master/R/Analysis%20and%20figures/emissions_by_country_with_crf.Rmd'>code</a> | 
...
```{r,out.width="80%",fig.align = 'center',results='asis'}
cat("<br>")
include_graphics("Results/Plots/equity_perspectives_regions_6-1.png")
...
cat("<a href='https://github.com/mcc-apsis/AR6-Emissions-trends-and-drivers/raw/master/Results/Plot%20data/ipcc_ar6_figure_equity_perspectives.xlsx'>data</a> | 
    <a href='https://github.com/mcc-apsis/AR6-Emissions-trends-and-drivers/blob/master/R/Analysis%20and%20figures/equity_perspectives.Rmd'>code</a> | 
    <a href='https://github.com/mcc-apsis/AR6-Emissions-trends-and-drivers/raw/master/Results/Plots/equity_perspectives_regions_6-1.png'>download png</a>")
...
### Emissions change by region and sector in EDGARv6  

Estimates from the EDGARv6 database, which we use across the AR6 report, show varying impacts by sector, subsector and region.
