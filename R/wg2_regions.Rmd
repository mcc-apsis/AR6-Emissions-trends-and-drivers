...
## Description
These figures depict emissions trends for the WGII regions using data compiled by WGIII. Code for producing them can be found here: https://github.com/mcc-apsis/AR6-Emissions-trends-and-drivers/blob/master/R/wg2_regions.Rmd. An excel file with the data compiled for each figure is available on request. 
