...
trend_figure <- function(time_start,category,sector,gas) {
  ...
  p <- data %>%
    ...
    theme_bw() +
    ggtitle("B. Sector trend and income classification") +
...
p1 <- ggarrange(bar,trend$plot,nrow=2,ncol=1,heights = c(0.2,0.8),align = "v")
...
p2 <- annotate_figure(p2,
  top = text_grob("C. Decomposition of relative and absolute contribution by country",size = 12,hjust=0.75))
