...
wb <- openxlsx::createWorkbook(title = paste("cumulative_historical_emissions_by_region_2"))
...
openxlsx::saveWorkbook(wb,"../../Results/Plot data/cumulative_historical_emissions_by_region_2.xlsx",overwrite=T)
...
#   summarise(co2_cum=sum(ghg,na.rm = TRUE))
# 
...
#   mutate(ghg_ussr_cum_1750=hist_emissions_ussr_1750$co2_cum)%>%
...
# 
# ussr_shares<-ussr_shares %>%
#   mutate(ghg_ussr_cum_1850=hist_emissions_ussr_1850$co2_cum)%>%
...
#   mutate(ghg_yugo_cum_1850=hist_emissions_yugo_1850$co2_cum)%>%
...
#   group_by(region_ar6_6) %>%
#   mutate(co2_cum=sum(co2_cum,ghg_ussr_cum_1750,ghg_yugo_cum_1850,na.rm = TRUE)) %>%
#   select(region_ar6_6,co2_cum) %>%
#   mutate(source="CO2-FFI")
# 
...
#   group_by(region_ar6_6) %>%
#   mutate(co2_cum=sum(co2_cum,ghg_ussr_cum_1850,ghg_yugo_cum_1850,na.rm = TRUE)) %>%
#   select(region_ar6_6,co2_cum) %>%
#   mutate(source="CO2-FFI")
# 
# 
