...
hist_emissions_1850 %>%
  ggplot(aes(x="CO2 emissions from FFI and LULUCF",y=ghg_cum_1850,fill=region_ar6_10))+
  geom_bar(stat="identity",position = "stack")+
  ylab('CO2 Emissions (Gt)') +
  xlab('') +
  ggtitle("Cumulative CO2 emissions 1850-2019")+
...
hist_emissions_1850 %>%
  ggplot(aes(x="CO2 emissions from FFI and LULUCF",y=ghg_cum_1850,fill=region_ar6_6))+
  geom_bar(stat="identity",position = "stack")+
  ylab('CO2 Emissions (Gt)') +
  xlab('') +
  ggtitle("Cumulative CO2 emissions 1850-2019")+
