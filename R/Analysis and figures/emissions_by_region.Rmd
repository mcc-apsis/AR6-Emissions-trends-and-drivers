...
# remove the scenarios with positive growth (GCAM!!!!)
scenario_data <- scenario_data %>%
  filter(rate<0)
...
addWorksheet(wb,"overall_growth")
addWorksheet(wb,"region_per_capita")
...
writeData(wb, sheet = "overall_growth", region_growth, colNames = T, rowNames = F)
writeData(wb, sheet = "region_per_capita", country_ghg, colNames = T, rowNames = F)
