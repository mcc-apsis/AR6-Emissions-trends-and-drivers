...
data <- data %>% 
  ...
  add_row(region_ar6_6="ldc",var="Production CO2, incl. LULUCF (1850-2019)",category="b. Historical cumulative emissions by region") %>% 
  add_row(region_ar6_6="ldc",var="Production GHG, incl. LULUCF (2019)",category="a. Current population and emissions by region")
