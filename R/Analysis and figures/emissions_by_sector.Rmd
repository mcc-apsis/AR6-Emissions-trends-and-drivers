...
growth_rates <- function(data) {
  ...
  rates$total_rate[rates$year==1990] = ((rates$value[rates$year==2000]/rates$value[rates$year==1990])^(1/length(1990:2000))-1)*100
  
  rates$total_rate[rates$year==2000] = ((rates$value[rates$year==2010]/rates$value[rates$year==2000])^(1/length(2000:2010))-1)*100
  
  rates$total_rate[rates$year==2010] = ((rates$value[rates$year==end_year]/rates$value[rates$year==2010])^(1/length(end_year:2010))-1)*100
