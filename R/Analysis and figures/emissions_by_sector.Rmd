...
indirect_CO2_world <- gather(indirect_CO2_world,year,CO2_indirect,`1990`:`2018`) %>% 
...
growth_rates <- function(data) {
  ...
  rates$total_rate[rates$year==1990] = ((rates$value[rates$year==2000]/rates$value[rates$year==1990])^(1/(2000-1990))-1)*100
  
  rates$total_rate[rates$year==2000] = ((rates$value[rates$year==2010]/rates$value[rates$year==2000])^(1/(2010-2000))-1)*100
...
```{r totals,echo=FALSE,warning=FALSE,results='asis',fig.width=10,fig.height=12,fig.path="../../Results/Plots/Sectors/",dev=c('png','pdf')}
...
# Buildings ->indirect CO2 only until 2018, compilation with end-year 2019 therefore failed
...
```{r buildings_with_scope3, echo=FALSE, fig.height=6, fig.path="../../Results/Plots/Sectors/", fig.width=8, warning=FALSE, dev=c('png','pdf'), results='asis'}
