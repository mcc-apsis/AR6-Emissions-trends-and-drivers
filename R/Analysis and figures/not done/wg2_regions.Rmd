...
info = data.frame(x=c("Author","Last update","Code","","Units","Panel a","Panel b","Panel c","Panel d"),y=c("William F. Lamb",as.character(Sys.time()),"https://github.com/mcc-apsis/AR6-Emissions-trends-and-drivers/blob/master/R/Analysis%20and%20figures/wg2_regions.Rmd","","","tCO2eq/capita","GtCO2eq","MtCO2eq","GtCO2eq"))

openxlsx::writeData(wb, sheet = "Info",info, colNames = F, rowNames = F)


openxlsx::addWorksheet(wb,"Panel a")
openxlsx::writeData(wb, sheet = "Panel a",boxplot_data, colNames = T, rowNames = F)
openxlsx::addWorksheet(wb,"Panel b")
openxlsx::writeData(wb, sheet = "Panel b",spread(trend_data,year,GHG), colNames = T, rowNames = F)
openxlsx::addWorksheet(wb,"Panel c")
openxlsx::addWorksheet(wb,"Panel d")
openxlsx::writeData(wb, sheet = "Panel c",countries$data, colNames = T, rowNames = F)
openxlsx::writeData(wb, sheet = "Panel d",gas_sector$data, colNames = T, rowNames = F)

openxlsx::saveWorkbook(wb,"../../Results/Data/ipcc_wg2_africa_emissions.xlsx",overwrite=T)
