...
growth_rates <- function(data) {
  ...
  rates <- rates %>% 
    group_by(var) %>% 
    mutate(`1990-2000`=((((`2000`/`1990`)^(1/(2000-1990)))-1))*100) %>% 
    mutate(`2000-2010`=((((`2010`/`2000`)^(1/(2010-2000)))-1))*100) %>% 
