...
GHG_by_gas_1990 <- GHG_by_gas %>%
  filter(year==1990) %>%
  mutate(decade="1990")

GHG_by_gas<-rbind(GHG_by_gas,GHG_by_gas_1990,GHG_by_gas_2019)
...
openxlsx::saveWorkbook(wb,"../../Results/Data/ipcc_ar6_10_year_averages_gwp_ar6.xlsx",overwrite=T)
