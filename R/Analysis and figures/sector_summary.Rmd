...
# facet titles
titles <- data.frame(var=c("CO2","energy","energy_GDP","CO2_energy","GDP_POP","POP"),facet=c("CO2","Energy cons.","Energy intensity","Carbon intensity","GDP/ pop","Population"))
...
trend_figure <- function(trend_data,sector) {
  ...
  p <- trend_data %>%
    ...
    geom_text(data=shares %>% filter(subsector_title==shares$subsector_title[1]) %>% filter(year<=end_year),aes(x=ifelse(year==2010,year+4,year+5),y=1.072*max(shares$totals),label=paste0(ifelse(total_rate>0,"+","-"),signif(abs(total_rate),2),"%")),size=4,colour="#252525") +
...
```{r afolu_summary,echo=FALSE,warning=FALSE,dpi=300,fig.width=10,fig.height=8.5,fig.path="../../Results/Plots/Sectors/",dev=c('png','pdf')}
...
(wrap_elements(p1) / wrap_elements(p2 + p3 + p4 + plot_layout(widths=c(1,1.5,3)))) + plot_layout(heights=c(1,1.3))
...
```{r energy_summary,echo=FALSE,warning=FALSE,dpi=300,fig.width=10,fig.height=8.5,fig.path="../../Results/Plots/Sectors/",dev=c('png','pdf')}
...
```{r industry_summary,echo=FALSE,warning=FALSE,dpi=300,fig.width=10,fig.height=8.5,fig.path="../../Results/Plots/Sectors/",dev=c('png','pdf')}
...
```{r buildings_summary,echo=FALSE,warning=FALSE,dpi=300,fig.width=10,fig.height=8.5,fig.path="../../Results/Plots/Sectors/",dev=c('png','pdf')}
...
```{r transport_summary,echo=FALSE,warning=FALSE,dpi=300,fig.width=10,fig.height=8.5,fig.path="../../Results/Plots/Sectors/",dev=c('png','pdf')}
