...
trend_figure <- function(trend_data,sector) {
  ...
  p <- trend_data %>%
    ...
    geom_text(data=shares %>% filter(subsector_title==shares$subsector_title[1]),aes(x=year,y=1.09*max(shares$totals),label=paste(round(totals,0),  "Gt")),size=4,colour="#252525") +
...
```{r afolu_summary,echo=FALSE,warning=FALSE,dpi=300,fig.width=10,fig.height=8,fig.path="../../Results/Plots/Sectors/",dev=c('png','pdf')}
...
```{r energy_summary,echo=FALSE,warning=FALSE,dpi=300,fig.width=10,fig.height=8,fig.path="../../Results/Plots/Sectors/",dev=c('png','pdf')}
...
```{r industry_summary,echo=FALSE,warning=FALSE,dpi=300,fig.width=10,fig.height=8,fig.path="../../Results/Plots/Sectors/",dev=c('png','pdf')}
...
```{r buildings_summary,echo=FALSE,warning=FALSE,dpi=300,fig.width=10,fig.height=8,fig.path="../../Results/Plots/Sectors/",dev=c('png','pdf')}
...
```{r transport_summary,echo=FALSE,warning=FALSE,dpi=300,fig.width=10,fig.height=8,fig.path="../../Results/Plots/Sectors/",dev=c('png','pdf')}
...
```{r total_summary,echo=FALSE,warning=FALSE,dpi=300,fig.width=10,fig.height=8,fig.path="../../Results/Plots/Sectors/",dev=c('png','pdf')}
