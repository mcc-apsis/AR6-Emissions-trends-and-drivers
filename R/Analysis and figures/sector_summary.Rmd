...
(wrap_elements(p1) / wrap_elements(p2 + p3 + p4 + plot_layout(widths=c(1,1.4,3)))) + plot_layout(heights=c(1,1.3))
...
(wrap_elements(p1) / wrap_elements(p2 + p3 + p4 + plot_layout(widths=c(1,1.4,3)))) + plot_layout(heights=c(1,1.25))
