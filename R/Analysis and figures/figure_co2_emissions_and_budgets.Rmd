...
gcb <- openxlsx::read.xlsx('../../Data/Supplementary datasets/Global_Carbon_Budget_2020v1.0.xlsx',sheet="CDIAC CO2",rows=3:272,cols=1:9)
...
luc_uncertainties <- read.xlsx('../../Data/Not public/Land and GCB/Global Carbon Budget uncertainties.xlsx',sheet=1)
...
openxlsx::writeData(wb, sheet = "panel a CO2 trend", co2_trend, colNames = T, rowNames = F)
...
openxlsx::saveWorkbook(wb,paste0("../../Results/Plot data/ipcc_ar6_figure_co2_emissions_and_budgets.xlsx"),overwrite=T)
