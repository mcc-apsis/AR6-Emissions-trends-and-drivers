...
kaya_data <- openxlsx::read.xlsx("../../Data/kaya/kaya_data_flat.xlsx")
...
# join IPCC regions
kaya_data <- left_join(kaya_data,ipcc_regions %>% select(ISO,name,region_ar6_5,region_ar6_5_short,region_ar6_10),by=c("ISO"="ISO"))
