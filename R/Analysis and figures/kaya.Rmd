...
#kaya_data <- openxlsx::read.xlsx("../../Data/kaya/kaya_data_flat_210924.xlsx")
kaya_data <- read.csv('../../Data/kaya/kaya_data_flat_210924.csv')
...
hong <- left_join(hong,land %>% select(year,region_ar6_10,CO2_land=CO2), by = c("year", "region_ar6_10"))
hong <- hong %>% 
  mutate(GHG_total = GHG+CO2_land)
...
openxlsx::saveWorkbook(wb,paste0("../../Results/Data/ipcc_ar6_figure_data_kaya.xlsx"),overwrite=T)
