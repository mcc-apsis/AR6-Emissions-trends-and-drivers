...
# exclude Croatia, which came in from the last data update (FIX LATER!!)
...
```{r kaya,echo=FALSE,warning=FALSE,fig.width=8,fig.height=9}
...
######### check CO2 here against my data!!!!
