...
p2 <- countries %>%
  ...
  plot_theme +
  ylab("%/yr") +
  ggtitle(str_wrap("b. Avg. annual GHG emissions change",width=38)) +
...
p3 <- countries %>% 
  ...
  ggtitle(str_wrap("c. Change in annual GHG emissions",width=35)) +
    annotate(geom = 'text', label = 'Years: 2010-2019',
...
wrap_elements(p1) / wrap_elements((p2 + p3) / (p4 + p5)) + plot_layout(heights = c(1.1,2))
