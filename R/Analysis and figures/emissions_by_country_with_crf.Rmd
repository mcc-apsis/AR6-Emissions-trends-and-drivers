...
p1 <- plot_data %>%
  ...
  coord_cartesian(xlim = c(1990,2037), # This focuses the x-axis on the range of interest
                  clip = 'off') +
  big_trend_theme +
...
openxlsx::writeData(wb, sheet = "countries_2019", countries %>% select(-cutoff), colNames = T, rowNames = F)

openxlsx::saveWorkbook(wb,paste0("../../Results/Plot data/ipcc_ar6_countries_data",Sys.Date(),".xlsx"),overwrite=T)
