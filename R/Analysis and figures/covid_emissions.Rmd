...
```{r table, echo=FALSE,warning=FALSE,fig.width=8,fig.height=6}
...
## compare average 2010-2019 value, 2019 value, 2020 value
...
# p1 <- edgar_subsectors %>% ggplot(.,aes(y=-`2020 vs 2019 (%)`,x=subsector_title,fill=chapter_title)) +
#   geom_bar(stat='identity',color="#737373") +
#   #geom_text(aes(y=-`2020 vs 2019 (%)`+2.5,x=reorder(region_ar6_10,desc(region_ar6_10)),label=`2020 vs 2019 (%)`)) +
#   coord_flip() +
#   scale_fill_manual(values=colors) +
#   ylab("Reduction in 2020 emissions relative to 2019 (%)") +
#   theme(legend.position="none",
#         #axis.title.x = element_blank(),
#         axis.title.y = element_blank())
# 
# p2 <- edgar_subsectors %>% ggplot(.,aes(y=-`2020 vs 2019 (GtCO2)`,x=subsector_title,fill=chapter_title)) +
#   geom_bar(stat='identity',color="#737373") +
#   coord_flip() +
#   scale_fill_manual(values=colors) +
...
p1 <- edgar_regions %>% ggplot(.,aes(y=-`2020 vs 2019 (%)`,x=reorder(region_ar6_10,desc(region_ar6_10)),fill=region_ar6_10)) +
  geom_bar(stat='identity',color="#737373") +
  #geom_text(aes(y=-`2020 vs 2019 (%)`+2.5,x=reorder(region_ar6_10,desc(region_ar6_10)),label=`2020 vs 2019 (%)`)) +
  coord_flip() +
  scale_fill_manual(values=colors) +
...
p2 <- edgar_regions %>% ggplot(.,aes(y=-`2020 vs 2019 (GtCO2)`,x=reorder(region_ar6_10,desc(region_ar6_10)),fill=region_ar6_10)) +
  geom_bar(stat='identity',color="#737373") +
  coord_flip() +
  scale_fill_manual(values=colors) +
  ylab("Reduction in 2020 emissions relative to 2019 (GtCO2)") +
...
### Annual emissions from Global Carbon Project
