...
# 
# data <- rbind(gcb,edgar)

p_annual_gcb <- gcb %>% 
  ggplot(.,aes(x=year,y=value)) +
  geom_path(aes(group=dataset,color=dataset)) +
  geom_vline(aes(xintercept=1973),linetype = "dashed") +
  geom_text(data=data.frame(x=1973.5,y=12.5),aes(x,y,label=str_wrap("1973 Oil Crisis",width=15)),vjust=0.5,hjust=0,size=3.5) +
  geom_vline(aes(xintercept=1991),linetype = "dashed") +
  geom_text(data=data.frame(x=1991.5,y=12.5),aes(x,y,label=str_wrap("1991 Soviet Union dissolusion",width=18)),vjust=0.5,hjust=0,size=3.5) +
  geom_vline(aes(xintercept=2008),linetype = "dashed") +
  geom_text(data=data.frame(x=2008.5,y=12.5),aes(x,y,label=str_wrap("2008 Global financial crisis",width=18)),vjust=0.5,hjust=0,size=3.5) +
  geom_vline(aes(xintercept=2020),linetype = "dashed") +
  geom_text(data=data.frame(x=2020.5,y=12.5),aes(x,y,label=str_wrap("2020 COVID-19 pandemic",width=18)),vjust=0.5,hjust=0,size=3.5) +
