...
# hotfix Ukraine and North Macedonia
# edgar_ghg <- edgar_ghg %>% 
#   mutate(region_ar6_6_short=as.character(region_ar6_6_short)) %>% 
#   mutate(region_ar6_6=ifelse(country=="Ukraine","Eastern Europe and West-Central Asia",region_ar6_6)) %>% 
#   mutate(region_ar6_6_short=ifelse(country=="Ukraine","EEA",region_ar6_6_short)) %>% 
#   mutate(region_ar6_10=ifelse(country=="Ukraine","Eurasia",region_ar6_10)) %>% 
#   mutate(region_ar6_10_short=ifelse(country=="Ukraine","Eurasia",region_ar6_10_short)) %>% 
#   mutate(region_ar6_6=ifelse(country=="Macedonia, FYR","Developed Countries",region_ar6_6)) %>% 
#   mutate(region_ar6_6_short=ifelse(country=="Macedonia, FYR","DEV",region_ar6_6_short)) %>% 
#   mutate(region_ar6_10=ifelse(country=="Macedonia, FYR","Europe",region_ar6_10)) %>% 
#   mutate(region_ar6_10_short=ifelse(country=="Macedonia, FYR","Europe",region_ar6_10_short)) 
...
region_rates$aggregated_category <- factor(region_rates$aggregated_category,levels= levels(region_rates$aggregated_category)[c(1,2,5,6,7,8,4,3)])
