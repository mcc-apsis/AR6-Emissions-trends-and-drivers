...
```{r all_countries_trend_co2,echo=FALSE,warning=FALSE,fig.width=12,fig.height=14,fig.path="../../Results/Plots/Decarbonising countries/",dev=c('png','pdf')}
...
```{r all_countries_trend_ghg,echo=FALSE,warning=FALSE,fig.width=12,fig.height=14,fig.path="../../Results/Plots/Decarbonising countries/",dev=c('png','pdf')}
...
```{r all_countries_trend_lulucf,echo=FALSE,warning=FALSE,fig.width=10,fig.height=11,fig.path="../../Results/Plots/Decarbonising countries/",dev=c('png','pdf')}
...
```{r country_sectors_GHG,echo=FALSE,warning=FALSE,fig.width=6.5,fig.height=7,fig.path="../../Results/Plots/Decarbonising countries/",dev=c('png','pdf')}
