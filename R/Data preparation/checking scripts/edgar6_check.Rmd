...
edgar_raw_v1 <- edgar_raw %>% mutate(version="edgar6_v2")

load('../../../Data/edgar6_v4_data_raw.RData')
edgar_raw_v2 <- edgar_raw %>% mutate(version="edgar6_v4")
rm(edgar_raw)
...
edgar_ghg_v1 <- edgar_ghg %>% mutate(version="edgar6_v2")

load('../../../Data/edgar6_v4_data_ghg_gwp_ar6.RData')
edgar_ghg_v2 <- edgar_ghg %>% mutate(version="edgar6_v4")
rm(edgar_ghg)
