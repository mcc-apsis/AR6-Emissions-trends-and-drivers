...
# edgar_co2 <- openxlsx::read.xlsx('Data/EDGAR/EDGAR_v6.0_emissions_Fgases updated_GHG per 6 gases_1970_2020 (CO2) and 1970-2018 (non-CO2)_for_UNEP use_2021.xlsx',
#                                   sheet='CO2',startRow=5)
# colnames(edgar_co2)[55:56]<-c(2019,2020)
# 
# edgar_ch4 <- openxlsx::read.xlsx('Data/EDGAR/EDGAR_v6.0_emissions_Fgases updated_GHG per 6 gases_1970_2020 (CO2) and 1970-2018 (non-CO2)_for_UNEP use_2021.xlsx',
#                                   sheet='CH4',startRow=5)
# edgar_ch4<-edgar_ch4 %>%
#   mutate("2019"=NA) %>%
#   mutate("2020"=NA)
# 
# edgar_n2o <- openxlsx::read.xlsx('Data/EDGAR/EDGAR_v6.0_emissions_Fgases updated_GHG per 6 gases_1970_2020 (CO2) and 1970-2018 (non-CO2)_for_UNEP use_2021.xlsx',
#                                   sheet='N2O',startRow=5)
# edgar_n2o<-edgar_n2o %>%
#   mutate("2019"=NA) %>%
#   mutate("2020"=NA)
#
# edgar_fgas <- openxlsx::read.xlsx('Data/EDGAR/EDGAR_v6.0_emissions_Fgases updated_GHG per 6 gases_1970_2020 (CO2) and 1970-2018 (non-CO2)_for_UNEP use_2021.xlsx',
#                                 sheet='Fgas',startRow=5)
...
############ add savannah burning from Jos's sheet

# edgar_n2o_savannah <- openxlsx::read.xlsx('Data/EDGAR/21-09-17-EDGAR_v6.0_GHG =final= CO2 (1970-2020), CH4,N2O, incl Savanna Burning, Fgas (1970-2018) for UNEP.xls.xlsx',
#                                           sheet="N2O",startRow=5,cols = 1:55)
# edgar_n2o_savannah <- edgar_n2o_savannah %>% filter(IPCC_code_1996=="4E") %>% mutate("2020"=NA) %>% rename("Country_code_A3"="Countrcode_A3")
# edgar_n2o_savannah <- gather(edgar_n2o_savannah,year,value,`1970`:`2020`)
# 
# edgar_ch4_savannah <- openxlsx::read.xlsx('Data/EDGAR/21-09-17-EDGAR_v6.0_GHG =final= CO2 (1970-2020), CH4,N2O, incl Savanna Burning, Fgas (1970-2018) for UNEP.xls.xlsx',
#                                           sheet="CH4",startRow=5,cols = 1:55)
# edgar_ch4_savannah <- edgar_ch4_savannah %>% filter(IPCC_code_1996=="4E") %>% mutate("2020"=NA) %>% rename("Country_code_A3"="Countrcode_A3")
# edgar_ch4_savannah <- gather(edgar_ch4_savannah,year,value,`1970`:`2020`)
...
edgar_raw <- edgar_GHG
save(edgar_raw,file='Data/edgar6_v4_data_raw.RData')

edgar_ghg <- edgar_GHG_ar6
save(edgar_ghg,file='Data/edgar6_v4_data_ghg_gwp_ar6.RData')

edgar_ghg <- edgar_GHG_ar5
save(edgar_ghg,file='Data/edgar6_v4_data_ghg_gwp_ar5.RData')

edgar_ghg <- edgar_GHG_ar4
save(edgar_ghg,file='Data/edgar6_v4_data_ghg_gwp_ar4.RData')
