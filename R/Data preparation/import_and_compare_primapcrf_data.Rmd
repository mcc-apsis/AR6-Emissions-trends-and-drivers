...
crf_total_sector<-crf_total_sector %>%
  ...
  summarise(gwp_crf=sum(gwp_crf,na.rm = TRUE))
...
combined_crf_edgar <- left_join(crf_total_sector,edgar_data,by=c("area (ISO3)"="ISO","year"="year","gas"="gas")) %>%
