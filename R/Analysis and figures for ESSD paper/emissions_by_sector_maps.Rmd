...
p1_energy <- ggplot() + 
  ...
  ggtitle("a. GHG emissions per capita in the Energy sector in 2019 (note: axis limited to max 15tCO2eq/cap)")
p1_energy
...
p1_industry <- ggplot() + 
  ...
  theme(panel.border = element_rect(colour = "black",fill=NA),
        ...
        plot.margin = unit(c(0,0,0,0),units="cm"),
        plot.title = element_text(size=12)) +
  ggtitle("c. GHG emissions per capita in the Industry in 2019 (note: axis limited to max 15tCO2eq/cap)")
p1_industry
...
p1_buildings <- ggplot() + 
  ...
  theme(panel.border = element_rect(colour = "black",fill=NA),
        ...
        plot.margin = unit(c(0,0,0,0),units="cm"),
        plot.title = element_text(size=12)) +
  ggtitle("e. GHG emissions per capita in the Buildings sector in 2019 (note: axis limited to max 15tCO2eq/cap)")
p1_buildings
...
p1_transport <- ggplot() + 
  ...
  theme(panel.border = element_rect(colour = "black",fill=NA),
        ...
        plot.margin = unit(c(0,0,0,0),units="cm"),
        plot.title = element_text(size=12)) +
  ggtitle("g. GHG emissions per capita in the Transport sector in 2019 (note: axis limited to max 15tCO2eq/cap)")
p1_transport
...
p1_afolu <- ggplot() + 
  ...
  theme(panel.border = element_rect(colour = "black",fill=NA),
        ...
        plot.margin = unit(c(0,0,0,0),units="cm"),
        plot.title = element_text(size=12)) +
  ggtitle("i. GHG emissions per capita in AFOLU in 2019 (note: axis limited to max 15tCO2eq/cap)")
p1_afolu
