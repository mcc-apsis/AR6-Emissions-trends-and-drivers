...
plot_data <- plot_data %>%
  ...
  #mutate(region_ar6_5_short=ifelse(region_ar6_10=="Africa","AFR",region_ar6_5_short)) %>%
  #mutate(region_ar6_5=ifelse(region_ar6_10=="Africa","Africa",region_ar6_5))
...
plot_data$region_ar6_5_short <-  factor(plot_data$region_ar6_5_short,levels(plot_data$region_ar6_5_short)[c(1,7,3,4,5,6,2)])

plot_data$region_ar6_5 <- as.factor(plot_data$region_ar6_5)
plot_data$region_ar6_5 <-  factor(plot_data$region_ar6_5,levels(plot_data$region_ar6_5)[c(1,7,3,4,5,6,2)])
...
countries$region_ar6_5_short <- as.factor(countries$region_ar6_5_short)
countries$region_ar6_5_short <-  factor(countries$region_ar6_5_short,levels(plot_data$region_ar6_5_short)[1:6])
...
countries <- countries %>% 
  ...
  mutate(emissions_pgdp_crf = GHG_crf/gdp_ppp)
...
p2 <- countries %>%
  ...
  geom_bar(aes(y = avg_growth,fill=region_ar6_5_short),stat='identity',colour="#525252")+
...
p3 <- countries %>% 
  ...
  geom_bar(aes(y = abs_growth,fill=region_ar6_5_short),stat='identity',colour="#525252")+
...
p4 <- countries %>% 
  ...
  geom_bar(aes(y = emissions_pc ,fill=region_ar6_5_short),stat='identity',colour="#525252")+
...
p5 <- countries %>% 
  ...
  geom_bar(aes(y = emissions_pgdp ,fill=region_ar6_5_short),stat='identity',colour="#525252")+
