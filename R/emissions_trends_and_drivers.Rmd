...
waterfall_data <- waterfall %>% 
  select(gas,value_gwp_ar5=value)
waterfall_data <- left_join(waterfall_data,second_waterfall %>% select(gas,value_gwp_ar6=value))
...
decomp <- decomp_figure_countries(2010,'GHG',edgar_GHG_ar5,basic)
...
p1 <- plot_data %>%
  ...
  geom_text(data=shares %>% filter(year==2018),aes(x=2019,y=location,label=chapter_title,color=chapter_title,hjust=0)) +
  geom_vline(xintercept=c(1990,2000,2010,2018),alpha=0.3,linetype="dashed") +
  ylab("GHG emissions (GtCO2eq/yr)") +
  
  labs(fill="Sector") +
  scale_y_continuous(breaks=c(0,10,20,30,40,50,60)) +
  scale_x_continuous(breaks=c(1990,2000,2010,2018),limits=c(1990,2023)) +
