...
shares <- locate_shares(shares,"region_ar6_5",4)
...
p1 <- plot_data %>%
  ...
  geom_area() +
  geom_text(data=shares,aes(x=year,y=location,label=paste(round(fractions,0),"%",sep="")),size=3.5,colour="#252525")+
  geom_text(data=shares %>% filter(year==2017),aes(x=2018,y=location,label=region_ar6_5,color=region_ar6_5,hjust=0)) +
  geom_vline(xintercept=c(1990,2000,2010,2017),alpha=0.3,linetype="dashed") +
  
  labs(fill="Gas") +
  scale_y_continuous(breaks=c(0,10,20,30,40,50,60)) +
  scale_x_continuous(breaks=c(1990,2000,2010,2017),limits = c(1990,2025)) +
  big_trend_theme +
  theme(legend.position="none") +
...
decomp <- decomp_figure_countries(2010,'GHG',edgar_GHG,basic)
...
plot <- ggarrange(p1,p2,p3,ncol=1,nrow=3,heights=c(0.3,0.35,0.35))
plot
...
p1 <- plot_data %>%
  ...
  geom_text(data=shares %>% filter(year==2017),aes(x=2018,y=location,label=chapter_title,color=chapter_title,hjust=0)) +
  geom_vline(xintercept=c(1990,2000,2010,2017),alpha=0.3,linetype="dashed") +
  ylab("GHG emissions (GtCO2eq/yr)") +
  
  labs(fill="Sector") +
  scale_y_continuous(breaks=c(0,10,20,30,40,50,60)) +
  scale_x_continuous(breaks=c(1990,2000,2010,2017),limits=c(1990,2023)) +
  
  scale_fill_manual(values=ipcc_palette[3:7]) +
  scale_color_manual(values=ipcc_palette[3:7]) +
...
plot_data <- edgar_GHG %>% 
  ...
  filter(region_ar6_5!="Intl. Aviation") %>% 
  filter(region_ar6_5!="Intl. Shipping") %>% 
  group_by(year,region_ar6_5,chapter) %>% 
  summarise_at(vars(GHG),sum,na.rm=TRUE) %>% 
  mutate(GHG=GHG/1e9)

plot_data <- left_join(plot_data,sectors %>% select(chapter_title=value,everything()),by=c("chapter"="key"))
